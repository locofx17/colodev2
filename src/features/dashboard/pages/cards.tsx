...
import GoogleDrive from '@/features/bot-builder/components/load-modal/google-drive';
    ...
    const actions: TCardArray[] = [
        {
            id: 'my-computer',
            icon: is_mobile ? (
                <DerivLightLocalDeviceIcon height='36px' width='36px' />
            ) : (
        ...
        {
            id: 'bot-builder',
            icon: <DerivLightBotBuilderIcon height={is_mobile ? '36px' : '48px'} width={is_mobile ? '36px' : '48px'} />,
        ...
        {
            id: 'youtube-guide',
            icon: <Youtube height={is_mobile ? '36px' : '48px'} width={is_mobile ? '36px' : '48px'} color='#FF0000' />,
            content: <Localize i18n_default_text='YouTube Guide' />,
            callback: () => {
                window.open('https://www.youtube.com/@SebastianBlood', '_blank');
            },
        },
    ];
